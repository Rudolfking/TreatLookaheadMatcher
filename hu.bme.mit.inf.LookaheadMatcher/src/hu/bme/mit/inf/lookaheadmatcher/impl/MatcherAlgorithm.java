...
public class MatcherAlgorithm
{
	...
	public MultiSet<LookaheadMatching> getPatternMatches(AheadStructure patternState, boolean matchOne, NavigationHelper navHelper, ArrayList<Object> knownValues)
	{
			...
			HashMap<PVariable, Object> MatchingVariables) // matched vars
	{
		...
		ArrayList<Object>[] listOfSatisfieds = CollectConstraintMatchings(SearchedConstraints, MatchingVariables, costs);
	...
	@SuppressWarnings("unchecked")
	private ArrayList<Object>[] CollectConstraintMatchings(ArrayList<AxisConstraint> SearchedConstraints, HashMap<PVariable, Object> MatchingVariables, int[] costs)
	{
